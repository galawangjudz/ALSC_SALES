            ...
            success:function(resp){
                if(resp){
                    ...
                    if($size != ''){
                        ...
                        $('#uni_modal_2 .modal-dialog').removeAttr("class").addClass("modal-dialog modal-md modal-dialog-centered")
                    }
                    $('#uni_modal_2').modal({
                      show:true,
                      backdrop:'static',
...
<footer class="main-footer text-sm hidden-section">
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      ...
      <div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-default bg-maroon" disabled="disabled" type="button">Apply</button> </div>
    </div>
