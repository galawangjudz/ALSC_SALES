...
<div class="card card-outline rounded-0 card-blue">
	<div class="card-header">
		<h3 class="card-title"><b><i>Additional Accounts</b></i></h3>
	</div>
	<div class="card-body">
										...
										<tr>
											<td>
												<div class="form-group form-group-sm  no-margin-bottom">
													...
													<p class="select-customer"> <a href="#"  class="btn btn-flat bg-maroon" style="font-size:14px;"><span class="fa fa-plus" aria-hidden="true"></span>&nbsp;&nbsp;Select Location</a></p>
												</div>
												<div class="main_box">
													<div class="row">
														<div class="col-md-3">		
