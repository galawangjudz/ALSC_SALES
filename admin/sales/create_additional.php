							...
							<div class="panel-body form-group form-group-sm">
								<div class="lot_box">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<button type="submit" class="btn btn-flat btn-success float-right select-additional" data-loading-text="Finding..." id="btnfind">
...
<div id="insert_add" class="modal fade">
			...
			<table class="table table-bordered table-stripped">
				...
				$query =$conn->query("SELECT 
                    ...
                    FROM 
                        t_lots i
                    LEFT JOIN 
                        t_projects c ON i.c_site = c.c_code
                    LEFT JOIN 
                        t_house h ON i.c_lid = h.c_lid
                    JOIN 
                        t_additional_inventory a ON LEFT(a.buyers_account, 9) = i.c_lid
                    WHERE 
                        i.c_site = c.c_code  
                        AND i.c_status = 'Available'
                        AND a.c_agent_code = '105811'
                    ");
