									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control margin-bottom convert-num price-sqm" name="price_per_sqm" id="price_per_sqm" readonly value="<?php echo isset($price_sqm) ? $price_sqm : ''; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control margin-bottom convert-num l-amount" name="amount" id="amount" readonly value="<?php echo isset($amount) ? $amount : ''; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-md-8">
											<div class="form-group">
												...
												<input type="text" class="form-control margin-bottom convert-num lot-disc-amt" name="lot_disc_amt" id="lot_disc_amt" readonly value="<?php echo isset($lot_discount_amt) ? $lot_discount_amt : ''; ?>">
											</div>
										</div>
									</div>	
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control margin-bottom convert-num l-lcp required" name="lcp" id="lcp" value="<?php echo isset($lcp) ? $lcp : ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<thead>
									...
									<tbody>
										...
										<tr>
											...
											<td style="padding-top:10px;">
													<input type="text" class="form-control agent-pos" name="agent_position[]" value="<?php echo isset($c_position) ? $c_position : ''; ?>" readonly>
											</td>
											<td style="padding-top:10px;">
											...
											<td style="display: none;">
												<input type="hidden" class="form-control calculate agent-rate required" name="agent_rate[]" value="0">
											</td>

											<!-- Commission Amount - Hidden -->
											<td style="display: none;">
												<input type="hidden" class="form-control comm-amt" name="comm_amt[]" value="0">
											</td>
										...
										<?php endwhile; 
											...
											<!-- Hidden Agent Rate -->
											<td style="display: none;">
												<input type="hidden" class="form-control calculate agent-rate" name="agent_rate[]" value="0">
											</td>
